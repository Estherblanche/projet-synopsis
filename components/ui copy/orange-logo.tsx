...
export default function OrangeLogo(props: Props) {
  return (
    <Svg width={props.width} height={props.height} viewBox="0 0 283.5 283.5">
      <G>
        ...
        <G>
          ...
          <Path
            fill="#FFFFFF"
            d="M129.5,221.1l8.6-1.2l0.9,4.7c4.9-3.5,8.7-5.4,13.6-5.4c8.1,0,12.3,4.3,12.3,12.8v27.5h-10.4v-25.7
			c0-4.8-1.3-7-5-7c-3.1,0-6.2,1.4-9.7,4.4v28.3h-10.3V221.1z"
          />
          <Path
            fill="#FFFFFF"
            d="M233.7,260.2c-11.6,0-18.6-7.5-18.6-20.5c0-13.1,7-20.6,18.4-20.6c11.4,0,18.2,7.2,18.2,20.1
          ...
          <Path
            fill="#FFFFFF"
            d="M34.9,260.6c-10.3,0-19.5-6.5-19.5-20.8c0-14.3,9.3-20.8,19.5-20.8c10.3,0,19.5,6.5,19.5,20.8
          ...
          <Path
            fill="#FFFFFF"
            d="M61.5,220h9.9v4.6c1.9-2.5,6.5-5.5,10.9-5.5c0.4,0,0.9,0,1.3,0.1v9.7c-0.2,0-0.3,0-0.5,0
			c-4.5,0-9.5,0.7-11,4.2v26.2H61.5V220z"
          />
          <Path
            fill="#FFFFFF"
            d="M190.3,251c7.9-0.1,8.5-8.1,8.5-13.3c0-6.2-3-11.2-8.6-11.2c-3.7,0-7.9,2.7-7.9,11.6
          ...
          <Path
            fill="#FFFFFF"
            d="M255.7,206.8h-4.1v11.3h-2.2v-11.3h-4.1v-1.7h10.3V206.8z M272.7,218.1h-2.2v-10.9h-0.1l-4.3,10.9h-1.4
